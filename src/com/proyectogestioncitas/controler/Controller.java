	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Accept")) {
			...
			if(dbController.logUser(login, password)) {
				...
				JOptionPane.showMessageDialog(null, "Usuario/Contrase�a incorrectos", "Error inicio sesi�n", JOptionPane.ERROR_MESSAGE);
			}
		}
		...
		if(e.getActionCommand().equals("Send")) {
			...
			if(!email.equals("") || !name.equals("") || !surname.equals("") || !id.equals("") || !password.equals("") ||
				...
				JOptionPane.showMessageDialog(null, "Los campos no son correctos, no pueden estar vac�os.", "Error",
						JOptionPane.ERROR_MESSAGE);
			}
